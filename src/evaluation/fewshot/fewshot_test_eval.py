...
def main(config, pretrain_domain_idx, target_domain_idxs):
    ...
    for target_domain_idx in target_domain_idxs:
        ...
        for model_seed in model_seeds:
            ...
            checkpoint_filename = f"{training_task_name}_{spatial_split_types}_{model_name}_{model_type}_domains_src{pretrain_domain_idx}_tgt{target_domain_idx}_mseed{model_seed}_dseed{data_seed}_best.pth"
